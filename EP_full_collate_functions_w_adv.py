...
def collate_input_w_adv(batch: List[List[torch.Tensor]], max_len: int = None, fill_values: List[float] = None) -> \
    List[torch.Tensor]:
    ...
    #max_size = [512,512,1]
    max_size = [int(512/2),int(512/2),1,1]
    ...
    #citing_tok_ids, cited_tok_ids, label, advice, citing_cs_idx, cited_cs_idx, max_lengths
